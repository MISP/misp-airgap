...
setupGnuPG() {
    ...
    local GPG_REAL_NAME="Autogenerated Key"
    local GPG_COMMENT="WARNING: MISP AutoGenerated Key consider this Key VOID!"
    local GPG_EMAIL_ADDRESS="admin@admin.test"
    local GPG_KEY_LENGTH="3072"
...
# Write mysql credentials to file
if $mysql; then
...
echo -e "${VIOLET}/home/misp/mysql.txt${NC}"
echo "Contents:"
lxc exec $MISP_CONTAINER -- cat /home/misp/mysql.txt
echo -e "${VIOLET}/home/misp/MISP-authkey.txt${NC}"
echo "Contents:"
lxc exec $MISP_CONTAINER -- cat /home/misp/MISP-authkey.txt
echo "--------------------------------------------------------------------------------------------"
echo -e "${VIOLET}Autogenerated Admin:${NC}"
