...
# Warning
this installer will install MISP 2.4 which has reached end of life, please refer to the other installation methods until MISP airgap gets reworked to support MISP 2.5.
